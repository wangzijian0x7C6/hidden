...
| Show hidden items left of the notch | Mirrors hidden icons into the menu bar area left of the camera notch; requires Screen Recording, and Accessibility for click forwarding |
